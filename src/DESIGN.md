...
- `convex_hull/` is the root package for the convex hull implementation.
...
- `algorithm.py` wires the hull pipeline into the public `convex_hull(points)` API and normalizes the output start point.
